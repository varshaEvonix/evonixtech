...
module.exports.routes = {
    ...
    '/signup': 'Student_detailsController.signup',
    ...
    '/personalinfo': 'Personal_editController.editpersonal',
    '/personal_edit_submit/:id': 'Personal_editController.editpersonalsubmit',
    '/educationandlaoninfo': 'Education_editController.editeducation',
    ...
    '/login': 'Student_authController.student_login',
...
//   -------------------- varsha-------------------------------------------------------
    ...
    '/admin/delete_category': 'Static_pageController.delete_category',
    ...
    '/admin/checkpayout/:student_id/:loan_id': 'Admin_dashController.checkpayout',
